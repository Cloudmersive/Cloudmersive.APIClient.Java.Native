...
import com.cloudmersive.client.ntv.model.LanguageDetectionRequest;
import com.cloudmersive.client.ntv.model.LanguageDetectionResponse;
...
public class LanguageDetectionApi {
  ...
  public ApiResponse<LanguageDetectionResponse> languageDetectionGetLanguageWithHttpInfo(LanguageDetectionRequest input) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = languageDetectionGetLanguageRequestBuilder(input);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("languageDetectionGetLanguage", localVarResponse);
        }
        return new ApiResponse<LanguageDetectionResponse>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<LanguageDetectionResponse>() {}) // closes the InputStream
  ...
  private HttpRequest.Builder languageDetectionGetLanguageRequestBuilder(LanguageDetectionRequest input) throws ApiException {
    // verify the required parameter 'input' is set
    if (input == null) {
      throw new ApiException(400, "Missing the required parameter 'input' when calling languageDetectionGetLanguage");
    }
