...
import com.cloudmersive.client.ntv.model.XlsxWorksheet;
...
@JsonPropertyOrder({
  InsertXlsxWorksheetRequest.JSON_PROPERTY_INPUT_FILE_BYTES,
  InsertXlsxWorksheetRequest.JSON_PROPERTY_INPUT_FILE_URL,
  InsertXlsxWorksheetRequest.JSON_PROPERTY_WORKSHEET_TO_INSERT
})
...
public class InsertXlsxWorksheetRequest {
  ...
  public InsertXlsxWorksheetRequest() { 
  }
  ...
  **/
  ...
  public InsertXlsxWorksheetRequest worksheetToInsert(XlsxWorksheet worksheetToInsert) {
   ...
   /**
   * Get worksheetToInsert
   * @return worksheetToInsert
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")
  @JsonProperty(JSON_PROPERTY_WORKSHEET_TO_INSERT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  /**
   * Return true if this InsertXlsxWorksheetRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Arrays.equals(this.inputFileBytes, insertXlsxWorksheetRequest.inputFileBytes) &&
        Objects.equals(this.inputFileUrl, insertXlsxWorksheetRequest.inputFileUrl) &&
        Objects.equals(this.worksheetToInsert, insertXlsxWorksheetRequest.worksheetToInsert);
  }

  @Override
  public int hashCode() {
    return Objects.hash(Arrays.hashCode(inputFileBytes), inputFileUrl, worksheetToInsert);
  }
  ...
  public String toString() {
    ...
    sb.append("    worksheetToInsert: ").append(toIndentedString(worksheetToInsert)).append("\n");
    sb.append("}");
    return sb.toString();
  }
