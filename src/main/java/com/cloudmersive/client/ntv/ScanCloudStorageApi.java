...
@javax.annotation.processing.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2022-10-15T17:56:43.476821800-07:00[America/Los_Angeles]")
public class ScanCloudStorageApi {
  ...
  public ApiResponse<CloudStorageVirusScanResult> scanCloudStorageScanAwsS3FileWithHttpInfo(String accessKey, String secretKey, String bucketRegion, String bucketName, String keyName) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = scanCloudStorageScanAwsS3FileRequestBuilder(accessKey, secretKey, bucketRegion, bucketName, keyName);
    try {
      ...
      try {
        ...
        return new ApiResponse<CloudStorageVirusScanResult>(
          ...
          memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<CloudStorageVirusScanResult>() {}) // closes the InputStream
  ...
  private HttpRequest.Builder scanCloudStorageScanAwsS3FileRequestBuilder(String accessKey, String secretKey, String bucketRegion, String bucketName, String keyName) throws ApiException {
  ...
  public ApiResponse<CloudStorageAdvancedVirusScanResult> scanCloudStorageScanAwsS3FileAdvancedWithHttpInfo(String accessKey, String secretKey, String bucketRegion, String bucketName, String keyName, Boolean allowExecutables, Boolean allowInvalidFiles, Boolean allowScripts, Boolean allowPasswordProtectedFiles, Boolean allowMacros, Boolean allowXmlExternalEntities, Boolean allowInsecureDeserialization, Boolean allowHtml, String restrictFileTypes) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = scanCloudStorageScanAwsS3FileAdvancedRequestBuilder(accessKey, secretKey, bucketRegion, bucketName, keyName, allowExecutables, allowInvalidFiles, allowScripts, allowPasswordProtectedFiles, allowMacros, allowXmlExternalEntities, allowInsecureDeserialization, allowHtml, restrictFileTypes);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        ...
        return new ApiResponse<CloudStorageAdvancedVirusScanResult>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<CloudStorageAdvancedVirusScanResult>() {}) // closes the InputStream
