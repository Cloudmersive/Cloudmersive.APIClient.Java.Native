 ...
 */
@ApiModel(description = "Result of running an Update Table Cell command")
@JsonPropertyOrder({
  UpdateDocxTableCellResponse.JSON_PROPERTY_SUCCESSFUL,
  UpdateDocxTableCellResponse.JSON_PROPERTY_EDITED_DOCUMENT_U_R_L
})
...
public class UpdateDocxTableCellResponse {
  ...
  public UpdateDocxTableCellResponse() { 
  }

  public UpdateDocxTableCellResponse successful(Boolean successful) {
  ...
  **/
  ...
  public UpdateDocxTableCellResponse editedDocumentURL(String editedDocumentURL) {
  ...
  **/
  ...
  /**
   * Return true if this UpdateDocxTableCellResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UpdateDocxTableCellResponse updateDocxTableCellResponse = (UpdateDocxTableCellResponse) o;
    return Objects.equals(this.successful, updateDocxTableCellResponse.successful) &&
        Objects.equals(this.editedDocumentURL, updateDocxTableCellResponse.editedDocumentURL);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateDocxTableCellResponse {\n");
