...
@JsonPropertyOrder({
  OdsToJpgResult.JSON_PROPERTY_SUCCESSFUL,
  OdsToJpgResult.JSON_PROPERTY_JPG_RESULT_PAGES
})
...
public class OdsToJpgResult {
  ...
  **/
  ...
  /**
   * Return true if this OdsToJpgResult object is equal to o.
   */
  @Override
