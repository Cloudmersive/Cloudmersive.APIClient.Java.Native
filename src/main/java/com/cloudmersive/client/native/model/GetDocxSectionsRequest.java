...
@JsonPropertyOrder({
  GetDocxSectionsRequest.JSON_PROPERTY_INPUT_FILE_BYTES,
  GetDocxSectionsRequest.JSON_PROPERTY_INPUT_FILE_URL
})
...
public class GetDocxSectionsRequest {
  ...
  **/
  ...
  /**
   * Return true if this GetDocxSectionsRequest object is equal to o.
   */
  @Override
