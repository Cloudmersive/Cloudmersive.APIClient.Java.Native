 ...
 */
@ApiModel(description = "Result of running a Disable Shared Workbook command")
@JsonPropertyOrder({
  DisableSharedWorkbookResponse.JSON_PROPERTY_SUCCESSFUL,
  DisableSharedWorkbookResponse.JSON_PROPERTY_EDITED_DOCUMENT_U_R_L
})
...
public class DisableSharedWorkbookResponse {
  ...
  public DisableSharedWorkbookResponse() { 
  }

  public DisableSharedWorkbookResponse successful(Boolean successful) {
  ...
  **/
  ...
  public DisableSharedWorkbookResponse editedDocumentURL(String editedDocumentURL) {
  ...
  **/
  ...
  /**
   * Return true if this DisableSharedWorkbookResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DisableSharedWorkbookResponse disableSharedWorkbookResponse = (DisableSharedWorkbookResponse) o;
    return Objects.equals(this.successful, disableSharedWorkbookResponse.successful) &&
        Objects.equals(this.editedDocumentURL, disableSharedWorkbookResponse.editedDocumentURL);
  }
  ...
  public String toString() {
    ...
    sb.append("class DisableSharedWorkbookResponse {\n");
