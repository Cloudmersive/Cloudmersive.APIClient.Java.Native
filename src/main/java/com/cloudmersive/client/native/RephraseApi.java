...
import com.cloudmersive.client.native.model.RephraseRequest;
import com.cloudmersive.client.native.model.RephraseResponse;
...
public class RephraseApi {
  ...
  public ApiResponse<RephraseResponse> rephraseEnglishRephraseSentenceBySentenceWithHttpInfo(RephraseRequest input) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = rephraseEnglishRephraseSentenceBySentenceRequestBuilder(input);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("rephraseEnglishRephraseSentenceBySentence", localVarResponse);
        }
        return new ApiResponse<RephraseResponse>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<RephraseResponse>() {}) // closes the InputStream
  ...
  private HttpRequest.Builder rephraseEnglishRephraseSentenceBySentenceRequestBuilder(RephraseRequest input) throws ApiException {
    // verify the required parameter 'input' is set
    if (input == null) {
      throw new ApiException(400, "Missing the required parameter 'input' when calling rephraseEnglishRephraseSentenceBySentence");
    }
