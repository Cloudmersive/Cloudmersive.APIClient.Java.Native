...
import java.io.File;
import com.cloudmersive.client.ntv.model.HtmlMdResult;
import com.cloudmersive.client.ntv.model.HtmlToOfficeRequest;
import com.cloudmersive.client.ntv.model.HtmlToPdfRequest;
import com.cloudmersive.client.ntv.model.HtmlToPngRequest;
import com.cloudmersive.client.ntv.model.HtmlToTextRequest;
import com.cloudmersive.client.ntv.model.HtmlToTextResponse;
import com.cloudmersive.client.ntv.model.ScreenshotRequest;
import com.cloudmersive.client.ntv.model.UrlToPdfRequest;
import com.cloudmersive.client.ntv.model.UrlToTextRequest;
import com.cloudmersive.client.ntv.model.UrlToTextResponse;
...
public class ConvertWebApiTest {
    ...
    public void convertWebHtmlToDocxTest() throws ApiException {
        ...
        byte[] response = 
        api.convertWebHtmlToDocx(inputRequest);
    ...
    public void convertWebHtmlToTxtTest() throws ApiException {
        ...
        HtmlToTextResponse response = 
        api.convertWebHtmlToTxt(input);
    ...
    public void convertWebMdToHtmlTest() throws ApiException {
        File inputFile = null;
        HtmlMdResult response = 
        api.convertWebMdToHtml(inputFile);
    ...
    public void convertWebUrlToScreenshotTest() throws ApiException {
        ...
        byte[] response = 
        api.convertWebUrlToScreenshot(input);
    ...
    public void convertWebUrlToTxtTest() throws ApiException {
        ...
        UrlToTextResponse response = 
        api.convertWebUrlToTxt(input);
