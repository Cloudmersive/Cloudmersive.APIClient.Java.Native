...
import com.cloudmersive.client.ntv.model.CountryListResult;
import com.cloudmersive.client.ntv.model.GetTimezonesRequest;
import com.cloudmersive.client.ntv.model.GetTimezonesResponse;
import com.cloudmersive.client.ntv.model.NormalizeAddressResponse;
import com.cloudmersive.client.ntv.model.ParseAddressRequest;
import com.cloudmersive.client.ntv.model.ParseAddressResponse;
import com.cloudmersive.client.ntv.model.ReverseGeocodeAddressRequest;
import com.cloudmersive.client.ntv.model.ReverseGeocodeAddressResponse;
import com.cloudmersive.client.ntv.model.ValidateAddressRequest;
import com.cloudmersive.client.ntv.model.ValidateAddressResponse;
import com.cloudmersive.client.ntv.model.ValidateCityRequest;
import com.cloudmersive.client.ntv.model.ValidateCityResponse;
import com.cloudmersive.client.ntv.model.ValidateCountryRequest;
import com.cloudmersive.client.ntv.model.ValidateCountryResponse;
import com.cloudmersive.client.ntv.model.ValidatePostalCodeRequest;
import com.cloudmersive.client.ntv.model.ValidatePostalCodeResponse;
import com.cloudmersive.client.ntv.model.ValidateStateRequest;
import com.cloudmersive.client.ntv.model.ValidateStateResponse;
...
public class AddressApiTest {
    ...
    public void addressCheckEUMembershipTest() throws ApiException {
        ...
        ValidateCountryResponse response = 
        api.addressCheckEUMembership(input);
    ...
    public void addressGetCountryCurrencyTest() throws ApiException {
        ValidateCountryRequest input = null;
        ValidateCountryResponse response = 
        api.addressGetCountryCurrency(input);
    ...
    public void addressGetCountryRegionTest() throws ApiException {
        ValidateCountryRequest input = null;
        ValidateCountryResponse response = 
        api.addressGetCountryRegion(input);
    ...
    public void addressNormalizeAddressTest() throws ApiException {
        ...
        api.addressNormalizeAddress(input);
    ...
    public void addressReverseGeocodeAddressTest() throws ApiException {
        ...
        ReverseGeocodeAddressResponse response = 
        api.addressReverseGeocodeAddress(input);
    ...
    public void addressValidateAddressTest() throws ApiException {
        ValidateAddressRequest input = null;
        ValidateAddressResponse response = 
        api.addressValidateAddress(input);
    ...
    public void addressValidateCityTest() throws ApiException {
        ...
        ValidateCityResponse response = 
        api.addressValidateCity(input);
    ...
    public void addressValidatePostalCodeTest() throws ApiException {
        ...
        ValidatePostalCodeResponse response = 
        api.addressValidatePostalCode(input);
    ...
    public void addressValidateStateTest() throws ApiException {
        ...
        ValidateStateResponse response = 
        api.addressValidateState(input);
