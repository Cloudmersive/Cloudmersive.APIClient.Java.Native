...
import java.io.File;
import com.cloudmersive.client.ntv.model.PdfToLinesWithLocationResult;
import com.cloudmersive.client.ntv.model.PdfToTextResponse;
import com.cloudmersive.client.ntv.model.PdfToWordsWithLocationResult;
...
public class PdfOcrApiTest {
    ...
    public void pdfOcrPdfToLinesWithLocationTest() throws ApiException {
        ...
        PdfToLinesWithLocationResult response = 
        api.pdfOcrPdfToLinesWithLocation(imageFile, language, preprocessing);
    ...
    public void pdfOcrPdfToWordsWithLocationTest() throws ApiException {
        ...
        String language = null;
        String preprocessing = null;
        PdfToWordsWithLocationResult response = 
        api.pdfOcrPdfToWordsWithLocation(imageFile, language, preprocessing);
    ...
    public void pdfOcrPostTest() throws ApiException {
        ...
        String language = null;
        String preprocessing = null;
        PdfToTextResponse response = 
        api.pdfOcrPost(imageFile, recognitionMode, language, preprocessing);
