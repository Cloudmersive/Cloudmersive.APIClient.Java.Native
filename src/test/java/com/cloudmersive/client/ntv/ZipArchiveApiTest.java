...
import com.cloudmersive.client.ntv.model.CreateZipArchiveRequest;
import java.io.File;
import com.cloudmersive.client.ntv.model.ZipEncryptionAdvancedRequest;
import com.cloudmersive.client.ntv.model.ZipExtractResponse;
...
public class ZipArchiveApiTest {
    ...
    public void zipArchiveZipCreateTest() throws ApiException {
        ...
        byte[] response = 
        api.zipArchiveZipCreate(inputFile1, inputFile2, inputFile3, inputFile4, inputFile5, inputFile6, inputFile7, inputFile8, inputFile9, inputFile10);
    ...
    public void zipArchiveZipCreateAdvancedTest() throws ApiException {
        ...
        Object response = 
        api.zipArchiveZipCreateAdvanced(request);
    ...
    public void zipArchiveZipCreateEncryptedTest() throws ApiException {
        ...
        File inputFile10 = null;
        byte[] response = 
        api.zipArchiveZipCreateEncrypted(password, inputFile1, encryptionAlgorithm, inputFile2, inputFile3, inputFile4, inputFile5, inputFile6, inputFile7, inputFile8, inputFile9, inputFile10);
    ...
    public void zipArchiveZipCreateQuarantineTest() throws ApiException {
        ...
        String encryptionAlgorithm = null;
        Object response = 
        api.zipArchiveZipCreateQuarantine(password, inputFile1, encryptionAlgorithm);
    ...
    public void zipArchiveZipDecryptTest() throws ApiException {
        ...
        File inputFile = null;
        Object response = 
        api.zipArchiveZipDecrypt(zipPassword, inputFile);
    ...
    public void zipArchiveZipEncryptAdvancedTest() throws ApiException {
        ...
        Object response = 
        api.zipArchiveZipEncryptAdvanced(encryptionRequest);
    ...
    public void zipArchiveZipExtractTest() throws ApiException {
        File inputFile = null;
        ZipExtractResponse response = 
        api.zipArchiveZipExtract(inputFile);
