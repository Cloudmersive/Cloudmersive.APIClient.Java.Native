...
import java.io.File;
import com.cloudmersive.client.ntv.model.FindSymbolResult;
import com.cloudmersive.client.ntv.model.FineTextDetectionResult;
import com.cloudmersive.client.ntv.model.ImageDescriptionResponse;
import com.cloudmersive.client.ntv.model.ImageSimilarityHashDistanceRequest;
import com.cloudmersive.client.ntv.model.ImageSimilarityHashDistanceResponse;
import com.cloudmersive.client.ntv.model.ImageSimilarityHashResponse;
import com.cloudmersive.client.ntv.model.ObjectDetectionResult;
import com.cloudmersive.client.ntv.model.TextDetectionResult;
import com.cloudmersive.client.ntv.model.VehicleLicensePlateDetectionResult;
...
public class RecognizeApiTest {
    ...
    public void recognizeDescribeTest() throws ApiException {
        File imageFile = null;
        ImageDescriptionResponse response = 
        api.recognizeDescribe(imageFile);
    ...
    public void recognizeDetectAndUnskewDocumentTest() throws ApiException {
        ...
        byte[] response = 
        api.recognizeDetectAndUnskewDocument(imageFile, postProcessingEffect);
    ...
    public void recognizeDetectObjectsTest() throws ApiException {
        File imageFile = null;
        ObjectDetectionResult response = 
        api.recognizeDetectObjects(imageFile);
    ...
    public void recognizeDetectPeopleTest() throws ApiException {
        File imageFile = null;
        ObjectDetectionResult response = 
        api.recognizeDetectPeople(imageFile);
    ...
    public void recognizeDetectTextFineTest() throws ApiException {
        File imageFile = null;
        FineTextDetectionResult response = 
        api.recognizeDetectTextFine(imageFile);
    ...
    public void recognizeDetectTextLargeTest() throws ApiException {
        File imageFile = null;
        TextDetectionResult response = 
        api.recognizeDetectTextLarge(imageFile);
    ...
    public void recognizeDetectVehicleLicensePlatesTest() throws ApiException {
        File imageFile = null;
        VehicleLicensePlateDetectionResult response = 
        api.recognizeDetectVehicleLicensePlates(imageFile);
    ...
    public void recognizeFindSymbolTest() throws ApiException {
        ...
        FindSymbolResult response = 
        api.recognizeFindSymbol(inputImage, targetImage);
    ...
    public void recognizeSimilarityCompareTest() throws ApiException {
        ...
        byte[] response = 
        api.recognizeSimilarityCompare(baseImage, comparisonImage, recognitionMode);
    ...
    public void recognizeSimilarityHashTest() throws ApiException {
        File imageFile = null;
        String recognitionMode = null;
        ImageSimilarityHashResponse response = 
        api.recognizeSimilarityHash(imageFile, recognitionMode);
    ...
    public void recognizeSimilarityHashDistanceTest() throws ApiException {
        ...
        ImageSimilarityHashDistanceResponse response = 
        api.recognizeSimilarityHashDistance(request);
