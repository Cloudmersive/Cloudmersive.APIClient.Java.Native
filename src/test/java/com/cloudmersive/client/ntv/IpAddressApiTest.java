...
import com.cloudmersive.client.ntv.model.BotCheckResponse;
import com.cloudmersive.client.ntv.model.GeolocateResponse;
import com.cloudmersive.client.ntv.model.GeolocateStreetAddressResponse;
import com.cloudmersive.client.ntv.model.IPIntelligenceResponse;
import com.cloudmersive.client.ntv.model.IPReverseDNSLookupResponse;
import com.cloudmersive.client.ntv.model.IPThreatResponse;
import com.cloudmersive.client.ntv.model.TorNodeResponse;
...
public class IpAddressApiTest {
    ...
    public void iPAddressGeolocateStreetAddressTest() throws ApiException {
        String value = null;
        GeolocateStreetAddressResponse response = 
        api.iPAddressGeolocateStreetAddress(value);
    ...
    public void iPAddressIpIntelligenceTest() throws ApiException {
        String value = null;
        IPIntelligenceResponse response = 
        api.iPAddressIpIntelligence(value);
    ...
    public void iPAddressIsBotTest() throws ApiException {
        String value = null;
        BotCheckResponse response = 
        api.iPAddressIsBot(value);
    ...
    public void iPAddressIsThreatTest() throws ApiException {
        String value = null;
        IPThreatResponse response = 
        api.iPAddressIsThreat(value);
    ...
    public void iPAddressIsTorNodeTest() throws ApiException {
        String value = null;
        TorNodeResponse response = 
        api.iPAddressIsTorNode(value);
    ...
    public void iPAddressPostTest() throws ApiException {
        String value = null;
        GeolocateResponse response = 
        api.iPAddressPost(value);
    ...
    public void iPAddressReverseDomainLookupTest() throws ApiException {
        String value = null;
        IPReverseDNSLookupResponse response = 
        api.iPAddressReverseDomainLookup(value);
