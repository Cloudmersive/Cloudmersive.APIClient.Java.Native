...
import java.io.File;
import com.cloudmersive.client.ntv.model.XmlAddAttributeWithXPathResult;
import com.cloudmersive.client.ntv.model.XmlAddChildWithXPathResult;
import com.cloudmersive.client.ntv.model.XmlFilterWithXPathResult;
import com.cloudmersive.client.ntv.model.XmlQueryWithXQueryMultiResult;
import com.cloudmersive.client.ntv.model.XmlQueryWithXQueryResult;
import com.cloudmersive.client.ntv.model.XmlRemoveAllChildrenWithXPathResult;
import com.cloudmersive.client.ntv.model.XmlRemoveWithXPathResult;
import com.cloudmersive.client.ntv.model.XmlReplaceWithXPathResult;
import com.cloudmersive.client.ntv.model.XmlSetValueWithXPathResult;
...
public class ConvertDataApiTest {
    ...
    public void convertDataCsvToJsonTest() throws ApiException {
        ...
        Object response = 
        api.convertDataCsvToJson(inputFile, columnNamesFromFirstRow);
    ...
    public void convertDataCsvToXmlTest() throws ApiException {
        ...
        Boolean columnNamesFromFirstRow = null;
        byte[] response = 
        api.convertDataCsvToXml(inputFile, columnNamesFromFirstRow);
    ...
    public void convertDataJsonStringToXmlTest() throws ApiException {
        ...
        Object response = 
        api.convertDataJsonStringToXml(jsonString);
    ...
    public void convertDataJsonToXmlTest() throws ApiException {
        ...
        byte[] response = 
        api.convertDataJsonToXml(jsonObject);
    ...
    public void convertDataXlsToJsonTest() throws ApiException {
        File inputFile = null;
        Object response = 
        api.convertDataXlsToJson(inputFile);
    ...
    public void convertDataXlsxToJsonTest() throws ApiException {
        File inputFile = null;
        byte[] response = 
        api.convertDataXlsxToJson(inputFile);
    ...
    public void convertDataXlsxToXmlTest() throws ApiException {
        File inputFile = null;
        byte[] response = 
        api.convertDataXlsxToXml(inputFile);
    ...
    public void convertDataXmlEditAddAttributeWithXPathTest() throws ApiException {
        ...
        File inputFile = null;
        XmlAddAttributeWithXPathResult response = 
        api.convertDataXmlEditAddAttributeWithXPath(xpathExpression, xmlAttributeName, xmlAttributeValue, inputFile);
    ...
    public void convertDataXmlEditAddChildWithXPathTest() throws ApiException {
        ...
        File inputFile = null;
        XmlAddChildWithXPathResult response = 
        api.convertDataXmlEditAddChildWithXPath(xpathExpression, xmlNodeToAdd, inputFile);
    ...
    public void convertDataXmlEditRemoveAllChildNodesWithXPathTest() throws ApiException {
        String xpathExpression = null;
        File inputFile = null;
        XmlRemoveAllChildrenWithXPathResult response = 
        api.convertDataXmlEditRemoveAllChildNodesWithXPath(xpathExpression, inputFile);
    ...
    public void convertDataXmlEditReplaceWithXPathTest() throws ApiException {
        ...
        File inputFile = null;
        XmlReplaceWithXPathResult response = 
        api.convertDataXmlEditReplaceWithXPath(xpathExpression, xmlNodeReplacement, inputFile);
    ...
    public void convertDataXmlEditSetValueWithXPathTest() throws ApiException {
        ...
        File inputFile = null;
        XmlSetValueWithXPathResult response = 
        api.convertDataXmlEditSetValueWithXPath(xpathExpression, xmlValue, inputFile);
    ...
    public void convertDataXmlFilterWithXPathTest() throws ApiException {
        String xpathExpression = null;
        File inputFile = null;
        XmlFilterWithXPathResult response = 
        api.convertDataXmlFilterWithXPath(xpathExpression, inputFile);
    ...
    public void convertDataXmlQueryWithXQueryTest() throws ApiException {
        String xquery = null;
        File inputFile = null;
        XmlQueryWithXQueryResult response = 
        api.convertDataXmlQueryWithXQuery(xquery, inputFile);
    ...
    public void convertDataXmlQueryWithXQueryMultiTest() throws ApiException {
        ...
        XmlQueryWithXQueryMultiResult response = 
        api.convertDataXmlQueryWithXQueryMulti(xquery, inputFile1, inputFile2, inputFile3, inputFile4, inputFile5, inputFile6, inputFile7, inputFile8, inputFile9, inputFile10);
    ...
    public void convertDataXmlRemoveWithXPathTest() throws ApiException {
        String xpathExpression = null;
        File inputFile = null;
        XmlRemoveWithXPathResult response = 
        api.convertDataXmlRemoveWithXPath(xpathExpression, inputFile);
    ...
    public void convertDataXmlToJsonTest() throws ApiException {
        File inputFile = null;
        Object response = 
        api.convertDataXmlToJson(inputFile);
    ...
    public void convertDataXmlTransformWithXsltToXmlTest() throws ApiException {
        ...
        byte[] response = 
        api.convertDataXmlTransformWithXsltToXml(inputFile, transformFile);
