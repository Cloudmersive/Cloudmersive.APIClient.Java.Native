...
import com.cloudmersive.client.ntv.model.StringAutomaticThreatDetection;
import com.cloudmersive.client.ntv.model.StringInsecureDeserializationJsonDetection;
import com.cloudmersive.client.ntv.model.StringSqlInjectionDetectionResult;
import com.cloudmersive.client.ntv.model.StringXssProtectionResult;
import com.cloudmersive.client.ntv.model.StringXxeDetectionResult;
...
public class ContentThreatDetectionApiTest {
    ...
    public void contentThreatDetectionAutomaticThreatDetectionStringTest() throws ApiException {
        String value = null;
        StringAutomaticThreatDetection response = 
        api.contentThreatDetectionAutomaticThreatDetectionString(value);
    ...
    public void contentThreatDetectionCheckSqlInjectionStringTest() throws ApiException {
        String value = null;
        StringSqlInjectionDetectionResult response = 
        api.contentThreatDetectionCheckSqlInjectionString(value);
    ...
    public void contentThreatDetectionCheckXxeTest() throws ApiException {
        String value = null;
        StringXxeDetectionResult response = 
        api.contentThreatDetectionCheckXxe(value);
    ...
    public void contentThreatDetectionDetectInsecureDeserializationJsonStringTest() throws ApiException {
        String value = null;
        StringInsecureDeserializationJsonDetection response = 
        api.contentThreatDetectionDetectInsecureDeserializationJsonString(value);
    ...
    public void contentThreatDetectionProtectXssTest() throws ApiException {
        String value = null;
        StringXssProtectionResult response = 
        api.contentThreatDetectionProtectXss(value);
