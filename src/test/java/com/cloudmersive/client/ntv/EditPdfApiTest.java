...
import com.cloudmersive.client.ntv.model.AddPdfAnnotationRequest;
import java.math.BigDecimal;
import java.io.File;
import com.cloudmersive.client.ntv.model.GetPdfAnnotationsResult;
import com.cloudmersive.client.ntv.model.PdfFormFields;
import com.cloudmersive.client.ntv.model.PdfMetadata;
import com.cloudmersive.client.ntv.model.PdfTextByPageResult;
import com.cloudmersive.client.ntv.model.SetPdfFormFieldsRequest;
import com.cloudmersive.client.ntv.model.SetPdfMetadataRequest;
...
public class EditPdfApiTest {
    ...
    public void editPdfAddAnnotationsTest() throws ApiException {
        ...
        byte[] response = 
        api.editPdfAddAnnotations(request);
    ...
    public void editPdfConvertToPdfATest() throws ApiException {
        ...
        byte[] response = 
        api.editPdfConvertToPdfA(inputFile, conformanceLevel);
    ...
    public void editPdfDecryptTest() throws ApiException {
        ...
        File inputFile = null;
        byte[] response = 
        api.editPdfDecrypt(password, inputFile);
    ...
    public void editPdfDeletePagesTest() throws ApiException {
        ...
        File inputFile = null;
        byte[] response = 
        api.editPdfDeletePages(pageStart, pageEnd, inputFile);
    ...
    public void editPdfEncryptTest() throws ApiException {
        ...
        byte[] response = 
        api.editPdfEncrypt(inputFile, userPassword, ownerPassword, encryptionKeyLength);
    ...
    public void editPdfGetAnnotationsTest() throws ApiException {
        File inputFile = null;
        GetPdfAnnotationsResult response = 
        api.editPdfGetAnnotations(inputFile);
    ...
    public void editPdfGetFormFieldsTest() throws ApiException {
        File inputFile = null;
        PdfFormFields response = 
        api.editPdfGetFormFields(inputFile);
    ...
    public void editPdfGetMetadataTest() throws ApiException {
        ...
        api.editPdfGetMetadata(inputFile);
    ...
    public void editPdfGetPdfTextByPagesTest() throws ApiException {
        ...
        PdfTextByPageResult response = 
        api.editPdfGetPdfTextByPages(inputFile, textFormattingMode);
    ...
    public void editPdfInsertPagesTest() throws ApiException {
        ...
        byte[] response = 
        api.editPdfInsertPages(pageStartSource, pageEndSource, pageInsertBeforeDesitnation, sourceFile, destinationFile);
    ...
    public void editPdfLinearizeTest() throws ApiException {
        File inputFile = null;
        byte[] response = 
        api.editPdfLinearize(inputFile);
    ...
    public void editPdfRasterizeTest() throws ApiException {
        File inputFile = null;
        byte[] response = 
        api.editPdfRasterize(inputFile);
    ...
    public void editPdfReduceFileSizeTest() throws ApiException {
        ...
        byte[] response = 
        api.editPdfReduceFileSize(inputFile, quality);
    ...
    public void editPdfRemoveAllAnnotationsTest() throws ApiException {
        File inputFile = null;
        byte[] response = 
        api.editPdfRemoveAllAnnotations(inputFile);
    ...
    public void editPdfRemoveAnnotationItemTest() throws ApiException {
        ...
        File inputFile = null;
        byte[] response = 
        api.editPdfRemoveAnnotationItem(annotationIndex, inputFile);
    ...
    public void editPdfResizeTest() throws ApiException {
        ...
        File inputFile = null;
        byte[] response = 
        api.editPdfResize(paperSize, inputFile);
    ...
    public void editPdfRotateAllPagesTest() throws ApiException {
        ...
        File inputFile = null;
        byte[] response = 
        api.editPdfRotateAllPages(rotationAngle, inputFile);
    ...
    public void editPdfRotatePageRangeTest() throws ApiException {
        ...
        File inputFile = null;
        byte[] response = 
        api.editPdfRotatePageRange(rotationAngle, pageStart, pageEnd, inputFile);
    ...
    public void editPdfSetFormFieldsTest() throws ApiException {
        ...
        byte[] response = 
        api.editPdfSetFormFields(fieldValues);
    ...
    public void editPdfSetMetadataTest() throws ApiException {
        ...
        byte[] response = 
        api.editPdfSetMetadata(request);
    ...
    public void editPdfSetPermissionsTest() throws ApiException {
        ...
        byte[] response = 
        api.editPdfSetPermissions(ownerPassword, userPassword, inputFile, encryptionKeyLength, allowPrinting, allowDocumentAssembly, allowContentExtraction, allowFormFilling, allowEditing, allowAnnotations, allowDegradedPrinting);
    ...
    public void editPdfWatermarkTextTest() throws ApiException {
        ...
        byte[] response = 
        api.editPdfWatermarkText(watermarkText, inputFile, fontName, fontSize, fontColor, fontTransparency);
