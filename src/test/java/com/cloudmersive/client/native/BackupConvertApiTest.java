...
public class BackupConvertApiTest {
    ...
    public void dataintegrationBackupConvertMssqlBakGetTablesPostTest() throws ApiException {
        File inputFile = null;
        MssqlBakEnumerateTablesResult response = 
        api.dataintegrationBackupConvertMssqlBakGetTablesPost(inputFile);
    ...
    public void dataintegrationBackupConvertMssqlBakToCsvPostTest() throws ApiException {
        ...
        File inputFile = null;
        File response = 
        api.dataintegrationBackupConvertMssqlBakToCsvPost(tableName, inputFile);
