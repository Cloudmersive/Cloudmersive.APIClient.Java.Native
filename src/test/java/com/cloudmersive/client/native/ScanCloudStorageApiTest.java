...
import com.cloudmersive.client.native.model.CloudStorageAdvancedVirusScanResult;
import com.cloudmersive.client.native.model.CloudStorageVirusScanResult;
import java.io.File;
...
public class ScanCloudStorageApiTest {
    ...
    public void scanCloudStorageScanAwsS3FileTest() throws ApiException {
        ...
        api.scanCloudStorageScanAwsS3File(accessKey, secretKey, bucketRegion, bucketName, keyName);
    ...
    public void scanCloudStorageScanAwsS3FileAdvancedTest() throws ApiException {
        ...
        api.scanCloudStorageScanAwsS3FileAdvanced(accessKey, secretKey, bucketRegion, bucketName, keyName, allowExecutables, allowInvalidFiles, allowScripts, allowPasswordProtectedFiles, allowMacros, allowXmlExternalEntities, allowInsecureDeserialization, allowHtml, restrictFileTypes);
    ...
    public void scanCloudStorageScanAzureBlobAdvancedTest() throws ApiException {
        ...
        String restrictFileTypes = null;
        CloudStorageAdvancedVirusScanResult response = 
        api.scanCloudStorageScanAzureBlobAdvanced(connectionString, containerName, blobPath, allowExecutables, allowInvalidFiles, allowScripts, allowPasswordProtectedFiles, allowMacros, allowXmlExternalEntities, allowInsecureDeserialization, allowHtml, restrictFileTypes);
    ...
    public void scanCloudStorageScanGcpStorageFileAdvancedTest() throws ApiException {
        ...
        String restrictFileTypes = null;
        CloudStorageAdvancedVirusScanResult response = 
        api.scanCloudStorageScanGcpStorageFileAdvanced(bucketName, objectName, jsonCredentialFile, allowExecutables, allowInvalidFiles, allowScripts, allowPasswordProtectedFiles, allowMacros, allowXmlExternalEntities, allowInsecureDeserialization, allowHtml, restrictFileTypes);
    ...
    public void scanCloudStorageScanSharePointOnlineFileAdvancedTest() throws ApiException {
        ...
        String restrictFileTypes = null;
        CloudStorageAdvancedVirusScanResult response = 
        api.scanCloudStorageScanSharePointOnlineFileAdvanced(clientID, clientSecret, sharepointDomainName, siteID, tenantID, filePath, itemID, allowExecutables, allowInvalidFiles, allowScripts, allowPasswordProtectedFiles, allowMacros, allowXmlExternalEntities, allowInsecureDeserialization, allowHtml, restrictFileTypes);
