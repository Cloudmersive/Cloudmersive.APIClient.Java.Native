...
import com.cloudmersive.client.native.model.DrawPolygonRequest;
import com.cloudmersive.client.native.model.DrawRectangleRequest;
import com.cloudmersive.client.native.model.DrawTextRequest;
import java.io.File;
...
public class EditApiTest {
    ...
    public void editCompositeBasicTest() throws ApiException {
        ...
        byte[] response = 
        api.editCompositeBasic(location, baseImage, layeredImage);
    ...
    public void editCompositePreciseTest() throws ApiException {
        ...
        Integer height = null;
        byte[] response = 
        api.editCompositePrecise(baseImage, layeredImage, top, bottom, left, right, width, height);
    ...
    public void editContrastAdaptiveTest() throws ApiException {
        ...
        File imageFile = null;
        byte[] response = 
        api.editContrastAdaptive(gamma, imageFile);
    ...
    public void editCropCircleTest() throws ApiException {
        ...
        File imageFile = null;
        byte[] response = 
        api.editCropCircle(left, top, radius, imageFile);
    ...
    public void editCropRectangleTest() throws ApiException {
        ...
        File imageFile = null;
        byte[] response = 
        api.editCropRectangle(left, top, width, height, imageFile);
    ...
    public void editDropShadowTest() throws ApiException {
        ...
        File imageFile = null;
        byte[] response = 
        api.editDropShadow(X, Y, sigma, opacity, imageFile);
    ...
    public void editRemoveExifDataTest() throws ApiException {
        File imageFile = null;
        byte[] response = 
        api.editRemoveExifData(imageFile);
    ...
    public void editRemoveTransparencyTest() throws ApiException {
        File imageFile = null;
        byte[] response = 
        api.editRemoveTransparency(imageFile);
    ...
    public void editRotateTest() throws ApiException {
        ...
        File imageFile = null;
        byte[] response = 
        api.editRotate(degrees, imageFile);
