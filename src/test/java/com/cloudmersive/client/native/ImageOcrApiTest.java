...
import com.cloudmersive.client.native.model.BusinessCardRecognitionResult;
import java.io.File;
import com.cloudmersive.client.native.model.FormRecognitionResult;
import com.cloudmersive.client.native.model.ImageToLinesWithLocationResult;
import com.cloudmersive.client.native.model.ImageToTextResponse;
import com.cloudmersive.client.native.model.ImageToWordsWithLocationResult;
import com.cloudmersive.client.native.model.PhotoToWordsWithLocationResult;
import com.cloudmersive.client.native.model.ReceiptRecognitionResult;
...
public class ImageOcrApiTest {
    ...
    public void imageOcrImageLinesWithLocationTest() throws ApiException {
        ...
        ImageToLinesWithLocationResult response = 
        api.imageOcrImageLinesWithLocation(imageFile, language, preprocessing);
    ...
    public void imageOcrImageWordsWithLocationTest() throws ApiException {
        ...
        String language = null;
        String preprocessing = null;
        ImageToWordsWithLocationResult response = 
        api.imageOcrImageWordsWithLocation(imageFile, language, preprocessing);
    ...
    public void imageOcrPhotoRecognizeBusinessCardTest() throws ApiException {
        File imageFile = null;
        BusinessCardRecognitionResult response = 
        api.imageOcrPhotoRecognizeBusinessCard(imageFile);
    ...
    public void imageOcrPhotoRecognizeFormTest() throws ApiException {
        ...
        String language = null;
        FormRecognitionResult response = 
        api.imageOcrPhotoRecognizeForm(imageFile, formTemplateDefinition, recognitionMode, preprocessing, diagnostics, language);
    ...
    public void imageOcrPhotoRecognizeFormAdvancedTest() throws ApiException {
        ...
        String diagnostics = null;
        FormRecognitionResult response = 
        api.imageOcrPhotoRecognizeFormAdvanced(imageFile, bucketID, bucketSecretKey, recognitionMode, preprocessing, diagnostics);
    ...
    public void imageOcrPhotoRecognizeReceiptTest() throws ApiException {
        ...
        String language = null;
        String preprocessing = null;
        ReceiptRecognitionResult response = 
        api.imageOcrPhotoRecognizeReceipt(imageFile, recognitionMode, language, preprocessing);
    ...
    public void imageOcrPhotoToTextTest() throws ApiException {
        ...
        api.imageOcrPhotoToText(imageFile, recognitionMode, language);
    ...
    public void imageOcrPhotoWordsWithLocationTest() throws ApiException {
        ...
        String preprocessing = null;
        String diagnostics = null;
        PhotoToWordsWithLocationResult response = 
        api.imageOcrPhotoWordsWithLocation(imageFile, recognitionMode, language, preprocessing, diagnostics);
    ...
    public void imageOcrPostTest() throws ApiException {
        ...
        String preprocessing = null;
        ImageToTextResponse response = 
        api.imageOcrPost(imageFile, recognitionMode, language, preprocessing);
