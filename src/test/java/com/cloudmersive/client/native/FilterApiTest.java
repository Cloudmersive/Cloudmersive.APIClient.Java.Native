...
public class FilterApiTest {
    ...
    public void filterBlackAndWhiteTest() throws ApiException {
        File imageFile = null;
        byte[] response = 
        api.filterBlackAndWhite(imageFile);
    ...
    public void filterEdgeDetectTest() throws ApiException {
        ...
        File imageFile = null;
        byte[] response = 
        api.filterEdgeDetect(radius, imageFile);
    ...
    public void filterEmbossTest() throws ApiException {
        ...
        File imageFile = null;
        byte[] response = 
        api.filterEmboss(radius, sigma, imageFile);
    ...
    public void filterGaussianBlurTest() throws ApiException {
        ...
        File imageFile = null;
        byte[] response = 
        api.filterGaussianBlur(radius, sigma, imageFile);
    ...
    public void filterMotionBlurTest() throws ApiException {
        ...
        File imageFile = null;
        byte[] response = 
        api.filterMotionBlur(radius, sigma, angle, imageFile);
    ...
    public void filterPosterizeTest() throws ApiException {
        ...
        File imageFile = null;
        byte[] response = 
        api.filterPosterize(levels, imageFile);
    ...
    public void filterSwirlTest() throws ApiException {
        ...
        File imageFile = null;
        byte[] response = 
        api.filterSwirl(degrees, imageFile);
