...
public class AudioApiTest {
    ...
    public void audioConvertToAacTest() throws ApiException {
        ...
        File inputFile = null;
        byte[] response = 
        api.audioConvertToAac(fileUrl, bitRate, inputFile);
    ...
    public void audioConvertToM4aTest() throws ApiException {
        ...
        File inputFile = null;
        byte[] response = 
        api.audioConvertToM4a(fileUrl, bitRate, inputFile);
    ...
    public void audioConvertToMp3Test() throws ApiException {
        ...
        File inputFile = null;
        byte[] response = 
        api.audioConvertToMp3(fileUrl, bitRate, inputFile);
    ...
    public void audioConvertToWavTest() throws ApiException {
        ...
        File inputFile = null;
        byte[] response = 
        api.audioConvertToWav(fileUrl, sampleRate, inputFile);
