...
import com.cloudmersive.client.native.model.PosRequest;
import com.cloudmersive.client.native.model.PosResponse;
...
public class PosTaggerApiTest {
    ...
    public void posTaggerTagAdjectivesTest() throws ApiException {
        ...
        api.posTaggerTagAdjectives(request);
    ...
    public void posTaggerTagAdverbsTest() throws ApiException {
        PosRequest request = null;
        PosResponse response = 
        api.posTaggerTagAdverbs(request);
    ...
    public void posTaggerTagPronounsTest() throws ApiException {
        PosRequest request = null;
        PosResponse response = 
        api.posTaggerTagPronouns(request);
    ...
    public void posTaggerTagSentenceTest() throws ApiException {
        PosRequest request = null;
        PosResponse response = 
        api.posTaggerTagSentence(request);
