...
import com.cloudmersive.client.native.model.CheckResponse;
import com.cloudmersive.client.native.model.DomainQualityResponse;
import com.cloudmersive.client.native.model.IsAdminPathResponse;
import com.cloudmersive.client.native.model.PhishingCheckRequest;
import com.cloudmersive.client.native.model.PhishingCheckResponse;
import com.cloudmersive.client.native.model.UrlHtmlSsrfRequestFull;
import com.cloudmersive.client.native.model.UrlHtmlSsrfResponseFull;
import com.cloudmersive.client.native.model.UrlSafetyCheckRequestFull;
import com.cloudmersive.client.native.model.UrlSafetyCheckResponseFull;
import com.cloudmersive.client.native.model.UrlSsrfRequestBatch;
import com.cloudmersive.client.native.model.UrlSsrfRequestFull;
import com.cloudmersive.client.native.model.UrlSsrfResponseBatch;
import com.cloudmersive.client.native.model.UrlSsrfResponseFull;
import com.cloudmersive.client.native.model.ValidateUrlRequestFull;
import com.cloudmersive.client.native.model.ValidateUrlRequestSyntaxOnly;
import com.cloudmersive.client.native.model.ValidateUrlResponseFull;
import com.cloudmersive.client.native.model.ValidateUrlResponseSyntaxOnly;
import com.cloudmersive.client.native.model.WhoisResponse;
...
public class DomainApiTest {
    ...
    public void domainGetTopLevelDomainFromUrlTest() throws ApiException {
        ...
        ValidateUrlResponseSyntaxOnly response = 
        api.domainGetTopLevelDomainFromUrl(request);
    ...
    public void domainIsAdminPathTest() throws ApiException {
        String value = null;
        IsAdminPathResponse response = 
        api.domainIsAdminPath(value);
    ...
    public void domainPhishingCheckTest() throws ApiException {
        ...
        PhishingCheckResponse response = 
        api.domainPhishingCheck(request);
    ...
    public void domainQualityScoreTest() throws ApiException {
        String domain = null;
        DomainQualityResponse response = 
        api.domainQualityScore(domain);
    ...
    public void domainSafetyCheckTest() throws ApiException {
        ...
        UrlSafetyCheckResponseFull response = 
        api.domainSafetyCheck(request);
    ...
    public void domainSsrfCheckTest() throws ApiException {
        ...
        UrlSsrfResponseFull response = 
        api.domainSsrfCheck(request);
    ...
    public void domainSsrfCheckBatchTest() throws ApiException {
        ...
        UrlSsrfResponseBatch response = 
        api.domainSsrfCheckBatch(request);
    ...
    public void domainUrlFullTest() throws ApiException {
        ...
        ValidateUrlResponseFull response = 
        api.domainUrlFull(request);
    ...
    public void domainUrlHtmlSsrfCheckTest() throws ApiException {
        ...
        UrlHtmlSsrfResponseFull response = 
        api.domainUrlHtmlSsrfCheck(request);
    ...
    public void domainUrlSyntaxOnlyTest() throws ApiException {
        ValidateUrlRequestSyntaxOnly request = null;
        ValidateUrlResponseSyntaxOnly response = 
        api.domainUrlSyntaxOnly(request);
