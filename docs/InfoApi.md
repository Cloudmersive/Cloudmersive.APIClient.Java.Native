...
| [**infoGetDominantColorWithHttpInfo**](InfoApi.md#infoGetDominantColorWithHttpInfo) | **POST** /image/get-info/dominant-color | Returns the dominant colors of the image |
...
| [**infoGetMetadataWithHttpInfo**](InfoApi.md#infoGetMetadataWithHttpInfo) | **POST** /image/get-info/metadata | Returns the image metadata including EXIF and resolution |
...
import com.cloudmersive.client.native.InfoApi;
...
## infoGetDominantColorWithHttpInfo

> ApiResponse<DominantColorResult> infoGetDominantColor infoGetDominantColorWithHttpInfo(imageFile)
...
public class Example {
    public static void main(String[] args) {
        ...
        File imageFile = new File("/path/to/file"); // File | Image file to perform the operation on.  Common file formats such as PNG, JPEG are supported.
        try {
            ApiResponse<DominantColorResult> response = apiInstance.infoGetDominantColorWithHttpInfo(imageFile);
...
ApiResponse<[**DominantColorResult**](DominantColorResult.md)>
...
## infoGetMetadataWithHttpInfo

> ApiResponse<ImageMetadata> infoGetMetadata infoGetMetadataWithHttpInfo(imageFile)
...
public class Example {
    public static void main(String[] args) {
        ...
        File imageFile = new File("/path/to/file"); // File | Image file to perform the operation on.  Common file formats such as PNG, JPEG are supported.
        try {
            ApiResponse<ImageMetadata> response = apiInstance.infoGetMetadataWithHttpInfo(imageFile);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
