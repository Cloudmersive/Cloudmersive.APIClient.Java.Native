...
| [**pdfOcrPdfToLinesWithLocationWithHttpInfo**](PdfOcrApi.md#pdfOcrPdfToLinesWithLocationWithHttpInfo) | **POST** /ocr/pdf/to/lines-with-location | Convert a PDF into text lines with location |
...
| [**pdfOcrPdfToWordsWithLocationWithHttpInfo**](PdfOcrApi.md#pdfOcrPdfToWordsWithLocationWithHttpInfo) | **POST** /ocr/pdf/to/words-with-location | Convert a PDF into words with location |
...
| [**pdfOcrPostWithHttpInfo**](PdfOcrApi.md#pdfOcrPostWithHttpInfo) | **POST** /ocr/pdf/toText | Converts an uploaded PDF file into text via Optical Character Recognition. |
...
import com.cloudmersive.client.native.PdfOcrApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        PdfOcrApi apiInstance = new PdfOcrApi(defaultClient);
...
## pdfOcrPdfToLinesWithLocationWithHttpInfo

> ApiResponse<PdfToLinesWithLocationResult> pdfOcrPdfToLinesWithLocation pdfOcrPdfToLinesWithLocationWithHttpInfo(imageFile, language, preprocessing)
...
public class Example {
    public static void main(String[] args) {
        ...
        String preprocessing = "preprocessing_example"; // String | Optional, preprocessing mode, default is 'Auto'.  Possible values are None (no preprocessing of the image), and Auto (automatic image enhancement of the image before OCR is applied; this is recommended).
        try {
            ApiResponse<PdfToLinesWithLocationResult> response = apiInstance.pdfOcrPdfToLinesWithLocationWithHttpInfo(imageFile, language, preprocessing);
...
ApiResponse<[**PdfToLinesWithLocationResult**](PdfToLinesWithLocationResult.md)>
...
## pdfOcrPdfToWordsWithLocationWithHttpInfo

> ApiResponse<PdfToWordsWithLocationResult> pdfOcrPdfToWordsWithLocation pdfOcrPdfToWordsWithLocationWithHttpInfo(imageFile, language, preprocessing)
...
public class Example {
    public static void main(String[] args) {
        ...
        String preprocessing = "preprocessing_example"; // String | Optional, preprocessing mode, default is 'Auto'.  Possible values are None (no preprocessing of the image), and Auto (automatic image enhancement of the image before OCR is applied; this is recommended).
        try {
            ApiResponse<PdfToWordsWithLocationResult> response = apiInstance.pdfOcrPdfToWordsWithLocationWithHttpInfo(imageFile, language, preprocessing);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
ApiResponse<[**PdfToWordsWithLocationResult**](PdfToWordsWithLocationResult.md)>
...
## pdfOcrPostWithHttpInfo

> ApiResponse<PdfToTextResponse> pdfOcrPost pdfOcrPostWithHttpInfo(imageFile, recognitionMode, language, preprocessing)
...
public class Example {
    public static void main(String[] args) {
        ...
        String preprocessing = "preprocessing_example"; // String | Optional, preprocessing mode, default is 'Auto'.  Possible values are None (no preprocessing of the image), and Auto (automatic image enhancement of the image before OCR is applied; this is recommended).
        try {
            ApiResponse<PdfToTextResponse> response = apiInstance.pdfOcrPostWithHttpInfo(imageFile, recognitionMode, language, preprocessing);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
ApiResponse<[**PdfToTextResponse**](PdfToTextResponse.md)>
