...
| [**vatVatLookupWithHttpInfo**](VatApi.md#vatVatLookupWithHttpInfo) | **POST** /validate/vat/lookup | Validate a VAT number |
...
import com.cloudmersive.client.native.VatApi;
...
## vatVatLookupWithHttpInfo

> ApiResponse<VatLookupResponse> vatVatLookup vatVatLookupWithHttpInfo(input)
...
public class Example {
    public static void main(String[] args) {
        ...
        VatLookupRequest input = new VatLookupRequest(); // VatLookupRequest | Input VAT code
        try {
            ApiResponse<VatLookupResponse> response = apiInstance.vatVatLookupWithHttpInfo(input);
...
ApiResponse<[**VatLookupResponse**](VatLookupResponse.md)>
