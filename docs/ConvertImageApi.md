...
| [**convertImageGetImageInfoWithHttpInfo**](ConvertImageApi.md#convertImageGetImageInfoWithHttpInfo) | **POST** /convert/image/get-info | Get information about an image |
...
| [**convertImageImageFormatConvertWithHttpInfo**](ConvertImageApi.md#convertImageImageFormatConvertWithHttpInfo) | **POST** /convert/image/{format1}/to/{format2} | Image format conversion |
| [**convertImageImageSetDPI**](ConvertImageApi.md#convertImageImageSetDPI) | **POST** /convert/image/set-dpi/{dpi} | Change image DPI |
| [**convertImageImageSetDPIWithHttpInfo**](ConvertImageApi.md#convertImageImageSetDPIWithHttpInfo) | **POST** /convert/image/set-dpi/{dpi} | Change image DPI |
...
| [**convertImageMultipageImageFormatConvertWithHttpInfo**](ConvertImageApi.md#convertImageMultipageImageFormatConvertWithHttpInfo) | **POST** /convert/image-multipage/{format1}/to/{format2} | Multi-page image format conversion |
...
import com.cloudmersive.client.native.ConvertImageApi;
...
## convertImageGetImageInfoWithHttpInfo

> ApiResponse<GetImageInfoResult> convertImageGetImageInfo convertImageGetImageInfoWithHttpInfo(inputFile)
...
public class Example {
    public static void main(String[] args) {
        ...
        File inputFile = new File("/path/to/file"); // File | Input file to perform the operation on.
        try {
            ApiResponse<GetImageInfoResult> response = apiInstance.convertImageGetImageInfoWithHttpInfo(inputFile);
...
ApiResponse<[**GetImageInfoResult**](GetImageInfoResult.md)>
...
## convertImageImageFormatConvertWithHttpInfo

> ApiResponse<byte[]> convertImageImageFormatConvert convertImageImageFormatConvertWithHttpInfo(format1, format2, inputFile)
...
public class Example {
    public static void main(String[] args) {
        ...
        File inputFile = new File("/path/to/file"); // File | Input file to perform the operation on.
        try {
            ApiResponse<byte[]> response = apiInstance.convertImageImageFormatConvertWithHttpInfo(format1, format2, inputFile);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
## convertImageImageSetDPIWithHttpInfo

> ApiResponse<byte[]> convertImageImageSetDPI convertImageImageSetDPIWithHttpInfo(dpi, inputFile)
...
public class Example {
    public static void main(String[] args) {
        ...
        File inputFile = new File("/path/to/file"); // File | Input file to perform the operation on.
        try {
            ApiResponse<byte[]> response = apiInstance.convertImageImageSetDPIWithHttpInfo(dpi, inputFile);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
## convertImageMultipageImageFormatConvertWithHttpInfo

> ApiResponse<MultipageImageFormatConversionResult> convertImageMultipageImageFormatConvert convertImageMultipageImageFormatConvertWithHttpInfo(format1, format2, inputFile)
...
public class Example {
    public static void main(String[] args) {
        ...
        File inputFile = new File("/path/to/file"); // File | Input file to perform the operation on.
        try {
            ApiResponse<MultipageImageFormatConversionResult> response = apiInstance.convertImageMultipageImageFormatConvertWithHttpInfo(format1, format2, inputFile);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
ApiResponse<[**MultipageImageFormatConversionResult**](MultipageImageFormatConversionResult.md)>
