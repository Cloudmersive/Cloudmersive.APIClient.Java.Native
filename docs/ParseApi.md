...
| [**parseParseStringWithHttpInfo**](ParseApi.md#parseParseStringWithHttpInfo) | **POST** /nlp-v2/parse/tree | Parse string to syntax tree |
...
import com.cloudmersive.client.native.ParseApi;
...
## parseParseStringWithHttpInfo

> ApiResponse<ParseResponse> parseParseString parseParseStringWithHttpInfo(input)
...
public class Example {
    public static void main(String[] args) {
        ...
        ParseRequest input = new ParseRequest(); // ParseRequest | Input string
        try {
            ApiResponse<ParseResponse> response = apiInstance.parseParseStringWithHttpInfo(input);
...
ApiResponse<[**ParseResponse**](ParseResponse.md)>
