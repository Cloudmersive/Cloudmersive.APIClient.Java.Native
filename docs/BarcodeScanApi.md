...
| [**barcodeScanImageWithHttpInfo**](BarcodeScanApi.md#barcodeScanImageWithHttpInfo) | **POST** /barcode/scan/image | Scan and recognize an image of a barcode |
...
import com.cloudmersive.client.native.BarcodeScanApi;
...
> ApiResponse<BarcodeScanResult> barcodeScanImage barcodeScanImageWithHttpInfo(imageFile)
...
public class Example {
    public static void main(String[] args) {
        ...
        File imageFile = new File("/path/to/file"); // File | Image file to perform the operation on.  Common file formats such as PNG, JPEG are supported.
        try {
            ApiResponse<BarcodeScanResult> response = apiInstance.barcodeScanImageWithHttpInfo(imageFile);
...
ApiResponse<[**BarcodeScanResult**](BarcodeScanResult.md)>
