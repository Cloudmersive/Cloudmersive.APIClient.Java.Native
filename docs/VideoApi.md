...
import com.cloudmersive.client.native.VideoApi;
...
## videoConvertToWebmWithHttpInfo
...
## videoResizeVideoWithHttpInfo

> ApiResponse<byte[]> videoResizeVideo videoResizeVideoWithHttpInfo(fileUrl, maxWidth, maxHeight, frameRate, quality, extension, inputFile)
