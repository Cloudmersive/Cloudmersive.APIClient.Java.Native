...
| [**barcodeLookupEanLookupWithHttpInfo**](BarcodeLookupApi.md#barcodeLookupEanLookupWithHttpInfo) | **POST** /barcode/lookup/ean | Lookup EAN barcode value, return product data |
...
import com.cloudmersive.client.native.BarcodeLookupApi;
...
> ApiResponse<BarcodeLookupResponse> barcodeLookupEanLookup barcodeLookupEanLookupWithHttpInfo(value)
...
public class Example {
    public static void main(String[] args) {
        ...
        String value = "value_example"; // String | Barcode value
        try {
            ApiResponse<BarcodeLookupResponse> response = apiInstance.barcodeLookupEanLookupWithHttpInfo(value);
...
ApiResponse<[**BarcodeLookupResponse**](BarcodeLookupResponse.md)>
